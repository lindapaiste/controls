...
export default (props: Props): Returns => {
  ...
  return {
    ...
    /**
     * mouse up ends the move if a drag has taken place, but does nothing, ie. continues the move, if there was no movement between mouse down and mouse up.
     */
    onMouseUp: (e) => {
      if (
